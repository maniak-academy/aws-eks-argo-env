...
resource "aws_instance" "mongodb_instance" {
  ...
  user_data = <<-EOF
              ...
              (crontab -l 2>/dev/null; echo "*/30 * * * * sudo /home/ubuntu/mongodb_backup.sh '$ADMIN_USER' '$ADMIN_PASSWORD' >> /home/ubuntu/mongodb_backup.log 2>&1") | crontab -
            EOF
}
